package modules.maiasObligationsRegister.domain;
...
public class Obligations extends AbstractPersistentBean {
	...
	/** @hidden */
	public static final String MODULE_NAME = "maiasObligationsRegister";
	...
	/** @hidden */
	public static final String obligationTypePropertyName = "obligationType";
	...
	@XmlEnum
	@Generated(value = "org.skyve.impl.generate.OverridableDomainGenerator")
	public static enum ObligationType implements Enumeration {
		conditionalObligation("Conditional Obligation", "Conditional Obligation"),
		strictObligation("Strict Obligation", "Strict Obligation");
		...
		/** @hidden */
		private static List<DomainValue> domainValues = Stream.of(values()).map(ObligationType::toDomainValue).collect(Collectors.toUnmodifiableList());

		private ObligationType(String code, String description) {
			this.code = code;
		...
		public static ObligationType fromCode(String code) {
			ObligationType result = null;
		...
		public static ObligationType fromLocalisedDescription(String description) {
			ObligationType result = null;
	...
	public static enum ResponsibleTeam implements Enumeration {
		all("All", "All"),
		dataAnalyticsClaimsPerformance("Data Analytics / Claims Performance", "Data Analytics / Claims Performance"),
	...
	public String getBizKey() {
		try {
			return org.skyve.util.Binder.formatMessage("Obligations - {reference}", this);
		}
	...
	/**
	 * {@link #obligationType} mutator.
	 * @param obligationType	The new value.
	 **/
	@XmlElement
	public void setObligationType(ObligationType obligationType) {
		preset(obligationTypePropertyName, obligationType);
